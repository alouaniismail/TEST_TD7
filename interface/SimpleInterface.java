...
class SimpleInterface {
  ...
  static public void main (String[] args) throws TecException {
    ...
    Usager kaylee = FabriqueTec.fairePassager("Kaylee", 4,0);
    Usager jayne = FabriqueTec.fairePassager("Jayne", 4,0);
    Usager inara = FabriqueTec.fairePassager("Inara", 5,0);
    //on a deja envisage cette possibilitée, donc on a pas change
    //de source de fabrique.
