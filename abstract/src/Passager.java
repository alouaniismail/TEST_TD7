...
abstract class Passager {
  // sans publique avec le mot abstract class
  // héritage non multiple'' mais héritage interne au paquetage.
  /**
   * fournit le nom de du passager.
   */
  // gérer l'accès au niveau de la portée des méthodes:
  // vu que ce n'est pas utilisées par le client.
  abstract String nom();
